        ...
        <div className="portfolio-card-shell">
          <div className="portfolio-card-grid__no-text">
            ...
            <div className="portfolio-left-panel">
              {/* NAV */}
              <PageNav backHref={"/services"} activePage="works" />
              ...
              <div className="portfolio-main-copy portfolio-scroll-area">
                <div className="portfolio-works-layout">
                  ...
                  <div className="portfolio-work-list">
                    {works.map((work, idx) => {
                      const isActive = idx === activeWorkIdx;
                      return (
                        <div
                          key={work.number}
                          className={`portfolio-work-list-item ${isActive ? "is-active" : ""
                        ...
                        >
                          <span className="portfolio-work-list-num">{idx + 1}</span>
                          <span className="portfolio-work-list-dash">—</span>
            ...
            <RightPanel sections={worksMediaSections} arrowSize={48} />
          </div>
        </div>
      </PageCard>
    </div>
